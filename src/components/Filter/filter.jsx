            ...
            <Flex className="option" >
                <div className="search-column">
                    <div className="items">
                        ...
                        <Input style={{
                            width: 200,
                        }} placeholder="Enter intern's D.O.B"></Input>
                    </div>
                    <div className="items">
                        ...
                        <Input style={{
                            width: 200,
                        }} placeholder="Enter intern's Email"></Input>
                    </div>
                    <div className="items">
                        ...
                        <Input style={{
                            width: 200,
                        }} placeholder="Enter intern's School"></Input>
                    </div>
                    <div className="items">
                        ...
                        <Input style={{
                            width: 200,
                        }} placeholder="Enter intern's Group Zalout"></Input>
                    </div>
                </div>
